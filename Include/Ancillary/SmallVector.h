...
#include <Ancillary/type_traits.h>
#include <algorithm>
#include <cassert>
#include <cstddef>
#include <cstdlib>
...
namespace std {
  ...
  template<typename T>
  inline void
  swap(dviview::SmallVectorImpl<T> &LHS, dviview::SmallVectorImpl<T> &RHS) {
    LHS.swap(RHS);
  }
  ...
  template<typename T, unsigned N>
  inline void
  swap(dviview::SmallVector<T, N> &LHS, dviview::SmallVector<T, N> &RHS) {
    LHS.swap(RHS);
  }
}
